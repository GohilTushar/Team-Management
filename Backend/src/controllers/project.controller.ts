...
export const createProjectController = asyncHandler(
  async (req: Request, res: Response) => {
    ...
    roleGuard(role, [permissionConfig.CREATE_PROJECT]);
...
export const getAllProjectsInWorkspaceController = asyncHandler(
  async (req: Request, res: Response) => {
    ...
    const { projects, totalCount, totalPages, skip } =
      await getProjectsInWorkspaceService(workspaceId, pageNumber,pageSize);
...
export const updateProjectController = asyncHandler(
  async (req: Request, res: Response) => {
    ...
    const { role } = await getMemberRoleInWorkspace(userId, workspaceId);
    roleGuard(role, [permissionConfig.EDIT_PROJECT]);
...
export const deleteProjectController = asyncHandler(
  async (req: Request, res: Response) => {
    ...
    const { role } = await getMemberRoleInWorkspace(userId, workspaceId);
    roleGuard(role, [permissionConfig.DELETE_PROJECT]);
